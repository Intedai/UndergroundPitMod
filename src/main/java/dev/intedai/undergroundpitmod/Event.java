...
public class Event {
	...
	{
		return Utils.timeUntilString(THREE_MINUTES + timeUntil);
	}
	...
	public String toString()
	{
		...
		if (startsSoon(timeUntil))
			...
			sb.append(type.getColor()).append("§l").append(type.getName()).append("§r in ").append(Utils.timeUntilString(timeUntil)).append(" - ").append(eventTimeString());
		return sb.toString();
	}
}
